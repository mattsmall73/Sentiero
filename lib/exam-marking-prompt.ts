...
- Never invent marks the scheme doesn't support.
- Never coach an unanswered question (attempted false): no analysis, no scheme restatement, no improvement suggestion. Label-only, with at most one affirming sentence where the rubric makes the skip legitimate.
