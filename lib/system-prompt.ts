...
- For exam paper inputs specifically, treat total_minutes as the exam duration itself and structure the guide as exam-time-coaching (tactical timing per section, when to pick essay options, when to read extracts, when to plan, when to write, when to review) rather than study scaffolding.
